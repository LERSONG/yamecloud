...
import (
	"fmt"
	"github.com/yametech/yamecloud/pkg/action/api/orchestration"
...
const serviceName = "orchestration"
...
func main() {
	...
	apiServer.SetExtends(orchestration.NewOrchestrationServer(serviceName, apiServer))
