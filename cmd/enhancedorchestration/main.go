...
import (
	"fmt"
	"github.com/yametech/yamecloud/pkg/action/api/enhancedorchestration"
...
const serviceName = "enhancedorchestration"
...
func main() {
	...
	apiServer.SetExtends(enhancedorchestration.NewEnhancedOrchestrationServer(serviceName, apiServer))
