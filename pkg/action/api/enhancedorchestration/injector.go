...
// Get Injector
func (s *enhancedOrchestrationServer) GetInjector(g *gin.Context) {
...
// Subscribe Injector
func (s *enhancedOrchestrationServer) ListInjector(g *gin.Context) {
...
// Update or Create Injector
func (s *enhancedOrchestrationServer) ApplyInjector(g *gin.Context) {
	namespace := g.Param("namespace")
...
// Delete Injector
func (s *enhancedOrchestrationServer) DeleteInjector(g *gin.Context) {
	namespace := g.Param("namespace")
	name := g.Param("name")
	if namespace == "" || name == "" {
		common.RequestParametersError(g, fmt.Errorf("params not obtain namespace=%s name=%s", namespace, name))
