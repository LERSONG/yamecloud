...
// Get DaemonSet
func (s *orchestrationServer) GetDaemonSet(g *gin.Context) {
...
// Subscribe DaemonSet
func (s *orchestrationServer) ListDaemonSet(g *gin.Context) {
...
// Update or Create DaemonSet
func (s *orchestrationServer) ApplyDaemonSet(g *gin.Context) {
	namespace := g.Param("namespace")
...
// Delete DaemonSet
func (s *orchestrationServer) DeleteDaemonSet(g *gin.Context) {
	namespace := g.Param("namespace")
	name := g.Param("name")
	if namespace == "" || name == "" {
		common.RequestParametersError(g, fmt.Errorf("params not obtain namespace=%s name=%s", namespace, name))
