...
// Get StatefulSet
func (s *orchestrationServer) GetStatefulSet(g *gin.Context) {
...
func (s *orchestrationServer) ListStatefulSet(g *gin.Context) {
...
// Update or Create StatefulSet
func (s *orchestrationServer) ApplyStatefulSet(g *gin.Context) {
	namespace := g.Param("namespace")
...
// Delete StatefulSet
func (s *orchestrationServer) DeleteStatefulSet(g *gin.Context) {
	namespace := g.Param("namespace")
	name := g.Param("name")
	if namespace == "" || name == "" {
		common.RequestParametersError(g, fmt.Errorf("params not obtain namespace=%s name=%s", namespace, name))
