...
// Get Deployment
func (s *orchestrationServer) GetDeployment(g *gin.Context) {
...
func (s *orchestrationServer) ListDeployment(g *gin.Context) {
...
func (s *orchestrationServer) ApplyDeployment(g *gin.Context) {
	namespace := g.Param("namespace")
...
// Delete Deployment
func (s *orchestrationServer) DeleteDeployment(g *gin.Context) {
	namespace := g.Param("namespace")
	name := g.Param("name")
	if namespace == "" || name == "" {
		common.RequestParametersError(g, fmt.Errorf("params not obtain namespace=%s name=%s", namespace, name))
